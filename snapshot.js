...
findRemoveSync(constants.XPX_SNAPSHOT_SOURCE + '/' + constants.XPX_NETWORK + '/', {dir: '*', file: '*.*', age: {seconds: constants.DELETE_OLDER_THAN_SECONDS}});
logger.info(constants.XPX_SNAPSHOT_DESTINATION);
